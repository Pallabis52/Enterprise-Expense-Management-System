                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <div className="hidden md:block w-64">
                        <div className="relative">
                            ...
                            <input
                                className="w-full pl-9 pr-4 py-2 text-sm bg-gray-100 dark:bg-gray-700/50 border-none rounded-full focus:ring-2 focus:ring-primary-500/50 dark:text-white"
                                placeholder="Search..."
                            />
                        </div>
                    </div>
                    ...
                    {/* User Profile Dropdown Trigger (Simple for now) */}
